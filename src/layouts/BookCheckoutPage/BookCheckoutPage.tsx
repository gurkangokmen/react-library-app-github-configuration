...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        ...
        // Because it's async (fetchBookReviews method), there can be an error.
        // So we catch any errors that can come back.
            ...
            <div className='container d-none d-lg-block'>
                ...
                <div className='row mt-5'>
                    <div className='col-sm-2 col-md-2'>
                        {/* book?.img checks if the book object exists and has a property named img. 
                    If book is null or undefined, the expression returns undefined without throwing an error. 
                    If book exists but does not have an img property, it also returns undefined. 
                    Therefore, the conditional rendering (ternary operator) is based on whether book?.img is truthy or falsy. */}
                        {book?.img ?
